		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXMethodDeclarationAccess().getGroup_4(), "rule__XMethodDeclaration__Group_4__0");
					put(grammarAccess.getXMethodDeclarationAccess().getGroup_4_1(), "rule__XMethodDeclaration__Group_4_1__0");
					...
					put(grammarAccess.getXMethodDeclarationAccess().getTypeAssignment_1(), "rule__XMethodDeclaration__TypeAssignment_1");
					put(grammarAccess.getXMethodDeclarationAccess().getNameAssignment_2(), "rule__XMethodDeclaration__NameAssignment_2");
					put(grammarAccess.getXMethodDeclarationAccess().getParametersAssignment_4_0(), "rule__XMethodDeclaration__ParametersAssignment_4_0");
					put(grammarAccess.getXMethodDeclarationAccess().getParametersAssignment_4_1_1(), "rule__XMethodDeclaration__ParametersAssignment_4_1_1");
					put(grammarAccess.getXMethodDeclarationAccess().getBodyAssignment_6(), "rule__XMethodDeclaration__BodyAssignment_6");
