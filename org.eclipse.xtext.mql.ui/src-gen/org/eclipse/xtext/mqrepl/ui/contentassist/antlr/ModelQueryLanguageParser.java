...
* generated by Xtext
*/
package org.eclipse.xtext.mqrepl.ui.contentassist.antlr;
...
public class ModelQueryLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.xtext.mqrepl.ui.contentassist.antlr.internal.InternalModelQueryLanguageParser createParser() {
		org.eclipse.xtext.mqrepl.ui.contentassist.antlr.internal.InternalModelQueryLanguageParser result = new org.eclipse.xtext.mqrepl.ui.contentassist.antlr.internal.InternalModelQueryLanguageParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXBlockExpressionWithoutBracesAccess().getGroup(), "rule__XBlockExpressionWithoutBraces__Group__0");
					put(grammarAccess.getXBlockExpressionWithoutBracesAccess().getGroup_1(), "rule__XBlockExpressionWithoutBraces__Group_1__0");
					put(grammarAccess.getXMethodDeclarationAccess().getGroup(), "rule__XMethodDeclaration__Group__0");
					put(grammarAccess.getXMethodDeclarationAccess().getGroup_1(), "rule__XMethodDeclaration__Group_1__0");
					put(grammarAccess.getXMethodDeclarationAccess().getGroup_1_2(), "rule__XMethodDeclaration__Group_1_2__0");
					put(grammarAccess.getXMethodDeclarationAccess().getGroup_5(), "rule__XMethodDeclaration__Group_5__0");
					put(grammarAccess.getXMethodDeclarationAccess().getGroup_5_1(), "rule__XMethodDeclaration__Group_5_1__0");
					...
					put(grammarAccess.getModelAccess().getMethodsAssignment_1(), "rule__Model__MethodsAssignment_1");
					put(grammarAccess.getModelAccess().getBodyAssignment_2(), "rule__Model__BodyAssignment_2");
					put(grammarAccess.getXBlockExpressionWithoutBracesAccess().getExpressionsAssignment_1_0(), "rule__XBlockExpressionWithoutBraces__ExpressionsAssignment_1_0");
					put(grammarAccess.getXMethodDeclarationAccess().getTypeParametersAssignment_1_1(), "rule__XMethodDeclaration__TypeParametersAssignment_1_1");
					put(grammarAccess.getXMethodDeclarationAccess().getTypeParametersAssignment_1_2_1(), "rule__XMethodDeclaration__TypeParametersAssignment_1_2_1");
					put(grammarAccess.getXMethodDeclarationAccess().getTypeAssignment_2(), "rule__XMethodDeclaration__TypeAssignment_2");
					put(grammarAccess.getXMethodDeclarationAccess().getNameAssignment_3(), "rule__XMethodDeclaration__NameAssignment_3");
					put(grammarAccess.getXMethodDeclarationAccess().getParametersAssignment_5_0(), "rule__XMethodDeclaration__ParametersAssignment_5_0");
					put(grammarAccess.getXMethodDeclarationAccess().getParametersAssignment_5_1_1(), "rule__XMethodDeclaration__ParametersAssignment_5_1_1");
					put(grammarAccess.getXMethodDeclarationAccess().getBodyAssignment_7(), "rule__XMethodDeclaration__BodyAssignment_7");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.xtext.mqrepl.ui.contentassist.antlr.internal.InternalModelQueryLanguageParser typedParser = (org.eclipse.xtext.mqrepl.ui.contentassist.antlr.internal.InternalModelQueryLanguageParser) parser;
