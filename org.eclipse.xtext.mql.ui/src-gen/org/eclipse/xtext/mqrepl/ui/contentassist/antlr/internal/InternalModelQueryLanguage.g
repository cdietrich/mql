...
{ before(grammarAccess.getXBlockExpressionWithoutBracesAccess().getExpressionsXExpressionOrVarDeclarationParserRuleCall_1_0_0()); }
	ruleXExpressionOrVarDeclaration{ after(grammarAccess.getXBlockExpressionWithoutBracesAccess().getExpressionsXExpressionOrVarDeclarationParserRuleCall_1_0_0()); }
)
