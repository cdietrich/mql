...
:
(
{ before(grammarAccess.getModelAccess().getBodyAssignment_1()); }
(rule__Model__BodyAssignment_1)
{ after(grammarAccess.getModelAccess().getBodyAssignment_1()); }
)
...
:
(
{ before(grammarAccess.getModelAccess().getBodyXBlockExpressionWithoutBracesParserRuleCall_1_0()); }
	ruleXBlockExpressionWithoutBraces{ after(grammarAccess.getModelAccess().getBodyXBlockExpressionWithoutBracesParserRuleCall_1_0()); }
)
