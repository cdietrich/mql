package org.eclipse.xtext.mqrepl.serializer;
...
public class AbstractModelQueryLanguageSemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected ModelQueryLanguageGrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ModelQueryLanguagePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case ModelQueryLanguagePackage.IMPORT:
			...
			case XbasePackage.XBLOCK_EXPRESSION:
				if(context == grammarAccess.getXBlockExpressionWithoutBracesRule()) {
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ModelQueryLanguagePackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ModelQueryLanguagePackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
	...
	/**
	 * Constraint:
	 *     (imports+=Import* body=XBlockExpressionWithoutBraces)
	 */
