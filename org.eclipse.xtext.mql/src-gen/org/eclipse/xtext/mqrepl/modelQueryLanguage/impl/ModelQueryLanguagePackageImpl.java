...
public class ModelQueryLanguagePackageImpl extends EPackageImpl implements ModelQueryLanguagePackage
{
   ...
   * @see org.eclipse.xtext.mqrepl.modelQueryLanguage.ModelQueryLanguagePackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static ModelQueryLanguagePackage init()
  {
    ...
    ModelQueryLanguagePackageImpl theModelQueryLanguagePackage = (ModelQueryLanguagePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ModelQueryLanguagePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ModelQueryLanguagePackageImpl());
